...
hellversion = "7.0"
# 🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔🤔
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "SLAYER ℓιgнтηιηg"
...
async def amireallyalive(alive):
    ...
    if ALIVE_PHOTTO:
        pm_caption = "🔥🔥SLAYER 𝐎𝐍 𝐅𝐈𝐑𝐄🔥🔥\n"
        pm_caption += f"               __↼🄼🄰🅂🅃🄴🅁⇀__\n**      『{DEFAULTUSER}』**\n\n"
        pm_caption += "𝐎𝐖𝐍𝐄𝐑             : [⚡COBRA⚡](@KING_COBRA_TERABAAP)\n" 
        pm_caption += "𝐓𝐄𝐋𝐄𝐓𝐇𝐎𝐍 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 : 1.17.5\n"
        pm_caption += "𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐂𝐇𝐀𝐍𝐍𝐄𝐋  : [ᴊᴏɪɴ](https://t.me/KING_COBRA_TERABAAP)\n"
        pm_caption += "𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏    : [ᴊᴏɪɴ](https://t.me/SLAYER_OFFICIAL_CHANELL)\n"
        pm_caption += "𝐓𝐄𝐀𝐌 𝐆𝐑𝐎𝐔𝐏       : [𝐒LAYER](https://t.me/SLAYER_USERBOT_SUPPORT_TEAM)\n\n"
        pm_caption += "[ꀷꏂᖘ꒒ꂦꌩ ꌩꂦꀎꋪ ꂦꅐꈤ ꌚꍏ꒦ꍏꁅꏂ](https://github.com/KING-USER1/SLAYER_USERBOT)\n"

...
print("𝐒LAYER 𝐁𝐎𝐓 has been deployed! ")

print("Setting up 𝐒LAYER 𝐁𝐎𝐓")
...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    sed.info("𝐒LAYER Bot Have Been Installed Successfully !")
else:
    sed.info("𝐒LAYER BOT Has Been Installed Sucessfully !")

...
RUN wget https://raw.githubusercontent.com/KING-USER1/SLAYER_USERBOT/master/slayer.py
RUN wget https://raw.githubusercontent.com/KING-USER1/SLAYER_USERBOT/master/requirements.txt
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN pip3 install -r requirements.txt
#CMD ["bash","boot_start.sh"]
CMD ["python3","slayer.py"]
